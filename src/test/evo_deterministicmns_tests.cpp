...
static CMutableTransaction CreateProRegTx(SimpleUTXOMap& utxos, int port, const CScript& scriptPayout, const CKey& coinbaseKey, CKey& ownerKeyRet, CBLSSecretKey& operatorKeyRet)
{
    ...
    FundTransaction(tx, utxos, scriptPayout, 150000 * COIN, coinbaseKey);
...
// {
//     std::cout << "Entering dip3_activation test" << std::endl;
...
// {
//     std::cout << "Entering dip3_protx test" << std::endl;
...
// {
//     std::cout << "Entering dip3_test_mempool_reorg test" << std::endl;
...
//     FundTransaction(tx_collateral, utxos, scriptCollateral, 150000 * COIN, coinbaseKey);
...
//         if (tx_collateral.vout[i].nValue == 150000 * COIN) {
...
//     FundTransaction(tx_reg, utxos, scriptPayout, 150000 * COIN, coinbaseKey);
...
// {
//     std::cout << "Entering dip3_test_mempool_dual_proregtx test" << std::endl;
...
//         if (tx_reg1.vout[i].nValue == 150000 * COIN) {
...
//     FundTransaction(tx_reg2, utxos, scriptPayout, 150000 * COIN, coinbaseKey);
...
// {
//     std::cout << "Entering dip3_verify_db test" << std::endl;
