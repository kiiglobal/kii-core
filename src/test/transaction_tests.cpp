...
{
    std::cout << "Entering tx_valid test" << std::endl;
...
{
    std::cout << "Entering tx_invalid test" << std::endl;
...
{
    std::cout << "Entering basic_transaction_tests test" << std::endl;
...
{
    std::cout << "Entering test_Get test" << std::endl;
...
{
    std::cout << "Entering test_IsStandard test" << std::endl;
