...
from test_framework.test_framework import KIITestFramework
...
class BlockRewardReallocationTest(KIITestFramework):
    def set_test_params(self):
        self.set_kii_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_kii_dip8_activation(450)
